    ...
    ACPI_RSCONVERT_INFO     *Info)
{
    ...
    while (Count)
    {
        ...
        case ACPI_RSC_INITGET:
             ...
             */
            memset_s (Resource, 0, INIT_RESOURCE_LENGTH (Info));
        ...
        case ACPI_RSC_SET8:
            ...
            memset_s (Destination, Info->AmlOffset, Info->Value);
            break;

        case ACPI_RSC_DATA8:

            Target = ACPI_ADD_PTR (char, Resource, Info->Value);
            memcpy_s (Destination, Source,  ACPI_GET16 (Target));
            break;
    ...
    ACPI_RSCONVERT_INFO     *Info)
{
    ...
    while (Count)
    {
        ...
        case ACPI_RSC_INITSET:
            ...
            memset_s (Aml, 0, INIT_RESOURCE_LENGTH (Info));
