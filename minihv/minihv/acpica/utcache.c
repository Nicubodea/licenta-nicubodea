    ...
    ACPI_CACHE_T        **ReturnCache)
{
    ...
    memset_s (Cache, 0, sizeof (ACPI_MEMORY_LIST));
    ...
    ACPI_CACHE_T        *Cache)
{
   ...
   /* Purge all objects in the cache */
    ...
    Status = AcpiOsPurgeCache ((ACPI_MEMORY_LIST*)Cache);
    if (ACPI_FAILURE (Status))
    {
        return (Status);
    }
    ...
    void                    *Object)
{
    ...
    else
    {
        ...
        memset_s (Object, 0xCA, Cache->ObjectSize);
    ...
    ACPI_MEMORY_LIST        *Cache)
{
    ...
    if (Cache->ListHead)
    {
        ...
        memset_s (Object, 0, Cache->ObjectSize);
    }
    else
    {
