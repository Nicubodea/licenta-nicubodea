    ...
    ACPI_OPERAND_OBJECT     *TargetDesc)
{
    ...
    if (Length <= TargetDesc->Buffer.Length)
    {
        ...
        memset_s (TargetDesc->Buffer.Pointer, 0, TargetDesc->Buffer.Length);
        memcpy_s (TargetDesc->Buffer.Pointer, Buffer, Length);
    ...
    else
    {
        ...
        memcpy_s (TargetDesc->Buffer.Pointer, Buffer,
    ...
    ACPI_OPERAND_OBJECT     *TargetDesc)
{
       ...
       (!(TargetDesc->Common.Flags & AOPOBJ_STATIC_POINTER)))
    {
         ...
         */
        memset_s (TargetDesc->String.Pointer, 0,
            (ACPI_SIZE) TargetDesc->String.Length + 1);
        memcpy_s (TargetDesc->String.Pointer, Buffer, Length);
    }
    else
    {
        /*
