    ...
    ACPI_PNP_DEVICE_ID      **ReturnId)
{
    ...
    {
        strcpy_s (Hid->String, ObjDesc->String.Pointer);
    }
    ...
    ACPI_PNP_DEVICE_ID      **ReturnId)
{
    ...
    strcpy_s (Sub->String, ObjDesc->String.Pointer);
    Sub->Length = Length;
    *ReturnId = Sub;
    ...
    ACPI_PNP_DEVICE_ID      **ReturnId)
{
    ...
    {
        strcpy_s (Uid->String, ObjDesc->String.Pointer);
    }
    ...
    ACPI_PNP_DEVICE_ID_LIST **ReturnCidList)
{
    ...
    for (i = 0; i < Count; i++)
    {
        ...
        else /* ACPI_TYPE_STRING */
        {
            ...
            strcpy_s (NextIdString, CidObjects[i]->String.Pointer);
