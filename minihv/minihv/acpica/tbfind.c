    ...
    UINT32                  *TableIndex)
{
    ...
    memset_s (&Header, 0, sizeof (ACPI_TABLE_HEADER));
    ...
    {
        if (memcmp_s (&(AcpiGbl_RootTableList.Tables[i].Signature),
        ...
        if (!memcmp_s (AcpiGbl_RootTableList.Tables[i].Pointer->Signature,
                            Header.Signature, ACPI_NAME_SIZE) &&
            (!OemId[0] ||
             !memcmp_s (AcpiGbl_RootTableList.Tables[i].Pointer->OemId,
                             Header.OemId, ACPI_OEM_ID_SIZE)) &&
            (!OemTableId[0] ||
             !memcmp_s (AcpiGbl_RootTableList.Tables[i].Pointer->OemTableId,
