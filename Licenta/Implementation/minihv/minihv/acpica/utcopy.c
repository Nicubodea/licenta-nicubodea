    ...
    ACPI_SIZE               *BufferSpaceUsed)
{
    ...
    *BufferSpaceUsed = 0;
    ...
    memset_s (ExternalObject, 0, sizeof (ACPI_OBJECT));
    ...
    ACPI_OPERAND_OBJECT     **RetInternalObject)
{
    ...
    case ACPI_TYPE_STRING:
        ...
        memcpy_s (InternalObject->String.Pointer,
    ...
    case ACPI_TYPE_BUFFER:
        ...
        memcpy_s (InternalObject->Buffer.Pointer,
    ...
    ACPI_OPERAND_OBJECT     *DestDesc)
{
    ...
    memcpy_s (ACPI_CAST_PTR (char, DestDesc),
    ...
    case ACPI_TYPE_BUFFER:
            ...
            (SourceDesc->Buffer.Length))
        {
            ...
            memcpy_s (DestDesc->Buffer.Pointer,
    ...
    case ACPI_TYPE_STRING:
        ...
        if (SourceDesc->String.Pointer)
        {
            ...
            memcpy_s (DestDesc->String.Pointer, SourceDesc->String.Pointer,
