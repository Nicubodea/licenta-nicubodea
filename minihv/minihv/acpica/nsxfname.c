    ...
    ACPI_HANDLE             *RetHandle)
{
    ...
    if (ACPI_IS_ROOT_PREFIX (Pathname[0]))
    {
        ...
        if (!strcmp_s (Pathname, ACPI_NS_ROOT_PATH))
        {
    ...
    char                    *StringArea)
{
    ...
    memcpy_s (StringArea, Source->String, Source->Length);
    ...
    UINT8                   *Buffer)
{
    ...
    AmlLength =(INT32) ACPI_PTR_DIFF (ParserState.PkgEnd, AmlStart);
    ...
    memcpy_s (AmlBuffer, AmlStart, AmlLength);
