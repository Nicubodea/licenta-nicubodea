    ...
    ACPI_WALK_STATE         *WalkState)
{
    ...
    memcpy_s (NewBuf, Operand0->Buffer.Pointer, Length0);
    memcpy_s (NewBuf + Length0, Operand1->Buffer.Pointer, Length1);
    ...
    ACPI_WALK_STATE         *WalkState)
{
    ...
    case ACPI_TYPE_INTEGER:
        ...
        memcpy_s (NewBuf, &Operand0->Integer.Value,
                        AcpiGbl_IntegerByteWidth);

        /* Copy the second integer (LSB first) after the first */

        memcpy_s (NewBuf + AcpiGbl_IntegerByteWidth,
    ...
    case ACPI_TYPE_STRING:
        ...
        strcpy_s (NewBuf, Operand0->String.Pointer);
        strcpy_s (NewBuf + Operand0->String.Length,
    ...
    case ACPI_TYPE_BUFFER:
        ...
        memcpy_s (NewBuf, Operand0->Buffer.Pointer,
                        Operand0->Buffer.Length);
        memcpy_s (NewBuf + Operand0->Buffer.Length,
    ...
    BOOLEAN                 *LogicalResult)
{
    ...
    else
    {
         ...
         *          memcmp_s to handle nulls in buffers.
         */
        ...
        Compare = memcmp_s (Operand0->Buffer.Pointer,
                    LocalOperand1->Buffer.Pointer,
