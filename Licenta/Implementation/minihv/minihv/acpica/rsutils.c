 ...
 *              via the ACPI_MOVE_* macros. (This is why a memcpy_s is not used)
 *
 ******************************************************************************/
    ...
    UINT8                   MoveType)
{
    ...
    for (i = 0; i < ItemCount; i++)
    {
        ...
        case ACPI_RSC_MOVE_SERIAL_RES:
            ...
            memcpy_s (Destination, Source, ItemCount);
            return;
 ...
 *              strcpy_s followed by a strlen_s.
 *
 ******************************************************************************/
    ...
    ACPI_RESOURCE_SOURCE    *ResourceSource)
{
    ...
    if (ResourceSource->StringLength)
    {
        ...
        strcpy_s (ACPI_CAST_PTR (char, &AmlResourceSource[1]),
