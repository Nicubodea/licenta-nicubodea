    ...
    ACPI_RESOURCE_ADDRESS64     *Out)
{
    ...
    case ACPI_RESOURCE_TYPE_ADDRESS64:
        ...
        memcpy_s (Out, &Resource->Data, sizeof (ACPI_RESOURCE_ADDRESS64));
        break;
    ...
    void                    *Context)
{
    ...
    if ((Vendor->ByteLength < (ACPI_UUID_LENGTH + 1)) ||
        ...
        (memcmp_s (Vendor->Uuid, Info->Uuid->Data, ACPI_UUID_LENGTH)))
    {
        return (AE_OK);
    }
    ...
    memcpy_s (Buffer->Pointer, Resource, Resource->Length);
