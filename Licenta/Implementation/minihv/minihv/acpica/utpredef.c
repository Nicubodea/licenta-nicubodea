    ...
    UINT32                  ExpectedBtypes)
{
    ...
    for (i = 0; i < ACPI_NUM_RTYPES; i++)
    {
        ...
        {
            strcat_s (Buffer, &UtRtypeNames[i][j]);
    ...
    UINT16                  ArgumentTypes)
{
    ...
    *Buffer = 0;
    ...
    for (i = 0; i < ArgCount; i++)
    {
        ...
        strcat_s (Buffer, UtExternalTypeNames[ThisArgumentType] + SubIndex);
        SubIndex = 0;
    }
    ...
    UINT16                  Types)
{
    ...
    *Buffer = 0;
    ...
    for (i = 0; i < NUM_RESOURCE_WIDTHS; i++)
    {
        if (Types & 1)
        {
            strcat_s (Buffer, &(UtResourceTypeNames[i][SubIndex]));
            SubIndex = 0;
            Found++;
        }
