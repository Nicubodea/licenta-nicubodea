    ...
    UINT32                  ReadWrite)
{
    ...
    case ACPI_TYPE_BUFFER_FIELD:
        ...
        else
        {
             ...
             * Length is the field width in bytes.
             */
            memcpy_s ((ObjDesc->BufferField.BufferObj)->Buffer.Pointer +
                ObjDesc->BufferField.BaseByteOffset +
                FieldDatumByteOffset,
    ...
    UINT32                  BufferLength)
{
    ...
    memset_s (Buffer, 0, BufferLength);
        ...
        (ObjDesc->CommonField.BitLength == AccessBitWidth))
    {
        ...
        else
        {
            ...
            memcpy_s (Buffer, &RawDatum, BufferLength);
        }
...
/* TBD: Move to common setup code */
    ...
    for (i = 1; i < FieldDatumCount; i++)
    {
        ...
        memcpy_s (((char *) Buffer) + BufferOffset, &MergedDatum,
    ...
    UINT32                  BufferLength)
{
    ...
    if (BufferLength < RequiredLength)
    {
         ...
         * buffer will be 0.
         */
        memcpy_s ((char *) NewBuffer, (char *) Buffer, BufferLength);
        Buffer = NewBuffer;
...
/* TBD: Move to common setup code */
    ...
    for (i = 1; i < FieldDatumCount; i++)
    {
        ...
        BufferOffset += ObjDesc->CommonField.AccessByteWidth;
        memcpy_s (&RawDatum, ((char *) Buffer) + BufferOffset,
            ACPI_MIN(ObjDesc->CommonField.AccessByteWidth,
                 BufferLength - BufferOffset));
