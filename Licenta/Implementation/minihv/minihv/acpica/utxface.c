    ...
    ACPI_STATISTICS         *Stats)
{
    ...
    memcpy_s (Stats->FixedEventCount, AcpiFixedEventCount,
    ...
    void)
{
    ...
    (void) AcpiOsPurgeCache ((ACPI_MEMORY_LIST*)AcpiGbl_StateCache);
    (void) AcpiOsPurgeCache ((ACPI_MEMORY_LIST*)AcpiGbl_OperandCache);
    (void) AcpiOsPurgeCache ((ACPI_MEMORY_LIST*)AcpiGbl_PsNodeCache);
    (void) AcpiOsPurgeCache ((ACPI_MEMORY_LIST*)AcpiGbl_PsNodeExtCache);
    ...
    ACPI_STRING             InterfaceName)
{
    ...
    if (!InterfaceName || (strlen_s (InterfaceName) == 0))
    {
        return (AE_BAD_PARAMETER);
    }
